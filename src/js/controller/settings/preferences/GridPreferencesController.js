(function () {
  ...
  ns.GridPreferencesController = function (
    piskelController,
    ...
    this.spacingPicker = new pskl.widgets.SizePicker(
      this.onSpacingPickerChanged_.bind(this)
    );
  };

  pskl.utils.inherit(
    ns.GridPreferencesController,
  ...
  ns.GridPreferencesController.prototype.init = function () {
    ...
    this.addEventListener(
      this.gridColorList,
      "click",
      this.onGridColorClicked_.bind(this)
    );
  };
  ...
  ns.GridPreferencesController.prototype.onSizePickerChanged_ = function (
    size
  ) {
    pskl.UserSettings.set(pskl.UserSettings.GRID_WIDTH, size);
  };

  ns.GridPreferencesController.prototype.onSpacingPickerChanged_ = function (
    size
  ) {
  ...
  ns.GridPreferencesController.prototype.onEnableGridChange_ = function (evt) {
    pskl.UserSettings.set(
      pskl.UserSettings.GRID_ENABLED,
